    ...
    HandleUserInput = (e) => {
        ...
        if (typeof (e.target.name) != 'undefined') {
            ...
            if (is_valid_entity == 'ddl') {
                ...
                targetname = e.target.name;
                /************ facing error  when click on radio button(commented on 13-09-18)*******************/
        ...
        if (pnkvalidate !== null) {
            ...
            if (pnkvalidate === 'forcecheckboxgroup') {
                ...
                if (targetchecked === true) {
                    let myeventobj = {id: targetname, value: myarrcheckboxgroup, whethererror: false};
                    // console.log('in true');
                    ...
                    if (myarrcheckboxgroup.length === 0)
                        myeventobj = {id: targetname, value: myarrcheckboxgroup, whethererror: true};
                    else
                        myeventobj = {id: targetname, value: myarrcheckboxgroup, whethererror: false};
                    this.HandleChangeValue(myeventobj);
                }
                // console.log(myarrcheckboxgroup);
                ...
                let myeventobj = {id: targetname, value: targetvalue, whethererror: this.whethererror};
                this.HandleChangeValue(myeventobj);
            } else {
                if (e.target.type === 'radio' || e.target.type === 'checkbox') {
                    myeventobj = {id: targetname, value: targetvalue, whethererror: this.whethererror};
                    alert(e.target.type+'@@@@@@@@@@@');
            ...
            if (e.target.type === 'radio' || e.target.type === 'checkbox') {
                ...
                myeventobj = {id: targetid, value: targetvalue, whethererror: false};
            }
