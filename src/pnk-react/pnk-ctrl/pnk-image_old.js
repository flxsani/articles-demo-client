        ...
        if (this.count <= this.limitFiles && event.target.files.length <= this.limitFiles) {
            for (var i = 0, numFiles = event.target.files.length; i < numFiles; i++) {
                ...
                if (this.FileValidation(file, this.allowedTypeStr)) {
                    ...
                    progressDiv.setAttribute('style','height:18px !important');
        ...
        if (r == true) {
            ...
            xhr.onreadystatechange = function () {
                ...
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    var uploadedFile = document.getElementById('uploadedFile').innerText;
                    ...
                    document.getElementById('uploadedFile').innerText = remainingFile;
        ...
        xhr.onreadystatechange = function () {
            ...
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                if (resp.response == true) {
                    ...
                    document.getElementById('uploadedFile').innerText += resp.fileName + ",";
            ...
            <div>
                <div style={{ border: '1px solid black', padding: '20px' }}>
                    ...
                    <form encType="multipart/form-data" method="post" id="frmUpload">
                        ...
                        <span id="uploadedFile" name="uploadedFile" style={{display:'none'}}></span>
